...
#install.packages(c("reshape2", "dplyr", "ggplot2", "Hmisc", "data.table"))
...
as.data.table(level2) -> lv2
lv2[social_group==1&sector==1] -> t #lv2[i,j,by]
lv2[,social_group]
lv2[,.(social_group)]
head(lv2[sector==1,.(meansize=weighted.mean(hhd_size,weight)),by=list(social_group,religion)])
lv2[,,by=list(social_group,religion)]
